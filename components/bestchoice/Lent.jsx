...
import BrakePad from "../../public/assets/bestchoice/best-car-brakes-new.png";
...
const Radiator = () => {
  return (
    <div className=" flex justify-center">
      <div className="radiatorbg w-[23rem] shadow-bestChoice sm:w-[35rem] h-[10rem] rounded-lg  sm:h-[15rem] lg:w-[50rem] flex justify-center relative items-center mb-16">
        ...
        <div className=" w-[20rem] h-[6rem] sm:w-[30rem] sm:h-[10rem] text-white bg-gradient-to-br flex justify-center items-center from-black relative z-0 to-gray-700 opacity-80 ">
          <div className=" flex justify-end flex-col">
            <h1 className=" text-xs sm:text-sm md:text-lg mb-2 md:mb-5">
              بهترین لنت خودرو را چگونه انتخاب کنیم؟
            </h1>
            <Link href="/bestchoicepage/lent">
