...
const LentsProduct = ({Lentdata}) => {
  return (
    <div>
      ...
      <div  className="bgLent md:pl-0 w-full lg:w-[90rem] md:h-[28rem] lg:h-[38rem] flex flex-col-reverse  relative h-[22rem] p-7 overflow-auto">
        <div>
          <ProductMaker dataInfo={Lentdata} />
        </div>
      </div>
